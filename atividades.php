...
<head>
  ...
  <title>Gincana JMF - Atividades</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="atividades.phpl"><i class="fas fa-gamepad"></i> Atividades</a>
...
<li class="nav-item">
      ...
      <div class="row">
        <div class="col-lg-4">
          <form action="" method="post">
            ...
            <div class="form-group">
              <label>Ponto:</label>
              <input type="text" name="ponto"  class="form-control form-control-user" id="exampleFirstPontos">
            </div>
            <div class="form-group">
              <button type="submit" name="botao" class="btn btn-secondary btn-user btn-block">Cadastrar</button>
            </div>
          </form>
          <?php
            ...
            if(isset($_POST['botao'])){
              ...
              $ponto = trim(strip_tags($_POST['ponto']));


              $cadastro = "INSERT INTO atividade (nome,ponto) VALUES (:nome,:ponto)";

                    try{
                      $result = $conect->prepare($cadastro);
                        $result->bindParam(':nome',$nome,PDO::PARAM_STR);
                        $result->bindParam(':ponto',$ponto,PDO::PARAM_STR);
                        $result->execute();
        ...
        <div class="col-lg-16">
          <table class="table display" id="table_id">
            ...
            <tbody>
              <?php
                $select = "SELECT * FROM atividade ORDER BY id DESC";
                try{
              ...
              <tr>
                ...
                <td><?php echo $show->ponto;?></td>
                <td><a href="home.php?acao=update&editar=<?php echo $show->id; ?>" class="btn btn-success"><i class="fas fa-edit"></i></a></td>
                <td><a href="delete.php?delete=<?php echo $show->id; ?>" class="btn btn-danger" onclick="return confirm('Deseja realmente deletar o Registro')"><i class="fas fa-trash"></i></a></td>
              </tr>
              <?php
  ...
  <!--Modal-->
 <div class="modal fade" id="logoutMod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
