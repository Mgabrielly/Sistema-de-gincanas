...
<head>
  ...
  <title>Gincana JMF - Editar</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="turmas.php"><i class="fas fa-users"></i>
                 Turmas</a>
          </div>
        </div>
      </li>
...
<li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h1 class="h3 mb-2 text-gray-800">Editar Atividades</h1>
      ...
      <div class="row">
        ...
        <?php
          ...
          $id = $_GET['editar'];
            ...
            $select = "SELECT * FROM atividade WHERE id=:id";
        ...
        <div class="col-lg-6">
          <form action="" method="post">
            <div class="form-group">
              <label>Nome:</label>
              <input value="<?php echo $nome; ?>" type="text" name="nome" class="form-control form-control-user" id="exampleFirstName">
            </div>
            <div class="form-group">
              <label>Ponto:</label>
              <input value="<?php echo $ponto; ?>" type="text" name="ponto"  class="form-control form-control-user" id="exampleFirstName">
            </div>
            <div class="form-group">
              <button type="submit" name="botao" class="btn btn-secondary btn-user btn-block">Atualizar Dados</button>
            </div>
          </form>
          <?php
            if(isset($_POST['botao'])){
              ...
              $update = "UPDATE atividade SET nome=:nome,ponto=:ponto WHERE id=:id";
